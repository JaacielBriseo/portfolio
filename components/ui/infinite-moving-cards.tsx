	...
	return (
		<div
			...
			<ul
				...
				{items.map((item, idx) => (
					<li
						className='w-[80vw] max-w-full relative rounded-2xl border flex-shrink-0 border-slate-800 p-5 md:p-16 md:w-[60vw]'
						style={{
							...
							<div className='relative z-20 mt-6 flex flex-row items-center'>
								<span className='flex flex-col gap-1'>
									...
									<div className='flex flex-col gap-1'>
										...
										<span className='leading-[1.6] text-white-200 font-bold text-xl'>
											{item.title}
										</span>
									</div>
								</span>
